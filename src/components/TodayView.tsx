  ...
  return (
    <div className="animate-fadeSlideUp">
      ...
      <div className="mb-10">
        ...
        <p className="text-[16px] text-gray-400 mt-2">Here&apos;s what matters today.</p>
      </div>

      {/* Rock Urgency Cards — horizontal scroll on mobile, grid on desktop */}
      <div className="mb-10">
          ...
          {sorted.map((rock) => {
            ...
            return (
              ...
              >
                ...
                {/* Name */}
                <h3 className="text-[16px] font-semibold text-gray-900 leading-snug mb-5 min-h-[48px] line-clamp-2">
                  {rock.name || "(unnamed)"}
                </h3>
      ...
      <Card className="mb-6" padding="lg">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-[17px] font-bold text-gray-800">Top 3 Priorities</h3>
        </div>
        <div className="space-y-1">
          {data.todayPriorities.map((p: Priority, i: number) => (
            ...
            >
              ...
              />
              <span className="text-[15px] font-bold text-gray-300 w-6 text-center select-none">
                {i + 1}
              </span>
              <input
                value={p.text}
                ...
                className={[
                  "flex-1 bg-transparent text-[16px] py-1 transition-all duration-150",
      ...
      <Card padding="lg">
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-emerald-50 flex items-center justify-center">
              <svg className="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4" />
                <rect x="3" y="3" width="18" height="18" rx="4" strokeLinecap="round" />
              </svg>
            </div>
            <h3 className="text-[17px] font-bold text-gray-800">To-Do List</h3>
            {data.todos.length > 0 && (
        ...
        {data.todos.length === 0 ? (
          <div className="text-center py-14">
            ...
            <p className="text-[15px] text-gray-400">No to-dos yet.</p>
          </div>
        ) : (
          <div className="space-y-1">
            {data.todos.map((todo, i) => (
              ...
              >
                ...
                <input
                  ...
                  placeholder="To-do..."
                  className={[
                    "flex-1 bg-transparent text-[15px] py-1 focus:outline-none",
                    "placeholder:text-gray-300",
                ...
                <input
                  ...
                  className="w-32 bg-transparent text-[13px] text-gray-400 py-1 focus:outline-none cursor-pointer"
                />
                <button
