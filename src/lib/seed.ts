...
export const SEED_SHARED: SharedData = {
  ...
  pipeline: {
    ...
    golf_networks: [
      /* ── Tier 3: Chain Brands ── */
      {
        id: uid(), pipeline: "golf_networks", company: "X-Golf", stage: "Cold Outreach", starred: true, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [
          { id: uid(), date: "2026-03-24", author: "drew", text: "Entertainment/sports bar concept. 140+ locations across 38 states. Proprietary sim tech. Full bar & restaurant. Franchise model. Each location independently owned = 140 potential affiliate partners." },
          { id: uid(), date: "2026-03-24", author: "drew", text: "PITCH ANGLE: Tier 3 social/entertainment venue. Larger footprint but more casual demo. Offer in-venue promo materials, league night giveaways, summer package bundles." },
        ],
        links: [
          { id: uid(), label: "Website", url: "https://playxgolf.com" },
          { id: uid(), label: "Locations Directory", url: "https://playxgolf.com/locations" },
        ],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["chain", "franchise", "tier-3", "entertainment"],
      },
      {
        id: uid(), pipeline: "golf_networks", company: "Five Iron Golf", stage: "Cold Outreach", starred: true, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [
          { id: uid(), date: "2026-03-24", author: "drew", text: "Urban social/sports bar. 40+ locations across 15+ states + DC. Trackman sims. Full bar & chef menu. Premium urban demo = perfect fit for high-end sub box. Members are affluent golfers. Summer promos already exist (50% off sims)." },
          { id: uid(), date: "2026-03-24", author: "drew", text: "LOCATIONS: DC, Atlanta, Chicago (4), Indianapolis, Louisville (2), Baltimore, Boston (2), Detroit (2), Minneapolis, St. Louis, Las Vegas, NYC (7), Port Chester, Syracuse, Cincinnati, Cleveland (2), OKC, Norman, Erie, Philadelphia (3), Pittsburgh, Nashville, DFW, Seattle (2), Norwalk CT, Miami — Coming Soon: Norman OK, DFW, Norwalk CT, Miami." },
          { id: uid(), date: "2026-03-24", author: "drew", text: "PITCH ANGLE: Tier 2 premium membership club. Members are affluent. Offer exclusive member discount, club gets flat fee per sign-up or % commission." },
        ],
        links: [
          { id: uid(), label: "Website", url: "https://fiveirongolf.com" },
        ],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["chain", "franchise", "tier-2", "urban", "premium"],
      },
      {
        id: uid(), pipeline: "golf_networks", company: "GolfCave", stage: "Cold Outreach", starred: true, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [
          { id: uid(), date: "2026-03-24", author: "drew", text: "Private 24/7 sim rooms. 8+ locations in NJ, expanding to NY/PA. Trackman. BYOB/BYOF. Membership-based recurring revenue. 24/7 unmanned model = tech-savvy, dedicated golfers. Perfect affiliate fit. VERY HIGH priority." },
          { id: uid(), date: "2026-03-24", author: "drew", text: "LOCATIONS: Clark NJ, Eatontown NJ, Green Brook NJ, Randolph NJ, Plainsboro NJ, Flemington NJ (pre-opening), New Providence NJ (pre-opening), Marlton NJ (pre-opening)." },
          { id: uid(), date: "2026-03-24", author: "drew", text: "PITCH ANGLE: Tier 1 unmanned club. Direct member contact info, digital-first ops, acute summer revenue problem. Offer 15-20% affiliate commission, co-branded landing page, QR codes in bays." },
        ],
        links: [
          { id: uid(), label: "Website", url: "https://www.golfcave.com" },
        ],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["chain", "franchise", "tier-1", "24/7", "unmanned"],
      },
      {
        id: uid(), pipeline: "golf_networks", company: "The Back Nine Golf", stage: "Cold Outreach", starred: true, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [
          { id: uid(), date: "2026-03-24", author: "drew", text: "24/7 private sim franchise. 8+ locations (FL, TX, NY, AZ, OR). Full Swing tech. No F&B (some BYOB). Members = dedicated golfers. Cross-play network = wide reach. Summer is their slowest period. VERY HIGH priority." },
          { id: uid(), date: "2026-03-24", author: "drew", text: "LOCATIONS: Ft Lauderdale N FL, Panama City Beach FL, League City TX, The Woodlands TX, Scottsdale N AZ, Five Towns NY (Lawrence), Sayville NY, Eugene OR." },
          { id: uid(), date: "2026-03-24", author: "drew", text: "PITCH ANGLE: Tier 1 unmanned club. Offer 15-20% affiliate commission, co-branded landing page, QR codes in bays." },
        ],
        links: [
          { id: uid(), label: "Website", url: "https://thebackninegolf.com" },
        ],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["chain", "franchise", "tier-1", "24/7", "unmanned"],
      },
      {
        id: uid(), pipeline: "golf_networks", company: "The Golf Crypt", stage: "Cold Outreach", starred: true, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [
          { id: uid(), date: "2026-03-24", author: "drew", text: "24/7 private sim. Expanding (HQ: Jupiter, FL). Membership only. No employees. Trackman. No F&B. Unmanned, membership-only — ideal affiliate partner. They need summer revenue badly and have direct member contact info. VERY HIGH priority." },
          { id: uid(), date: "2026-03-24", author: "drew", text: "PITCH ANGLE: Tier 1 unmanned club. Offer 15-20% affiliate commission, co-branded landing page, QR codes in bays." },
        ],
        links: [{ id: uid(), label: "Website", url: "https://golfcrypt.com" }],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["chain", "franchise", "tier-1", "24/7", "unmanned", "membership"],
      },
      {
        id: uid(), pipeline: "golf_networks", company: "24/7 Golf", stage: "Cold Outreach", starred: false, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [
          { id: uid(), date: "2026-03-24", author: "drew", text: "24/7 sim + pickleball. 5 locations in Michigan. Trackman iO. No F&B. Regional franchise. Open 24/7/365. Avid golfer base. Winter-heavy business seeking summer solutions." },
          { id: uid(), date: "2026-03-24", author: "drew", text: "LOCATIONS: Comstock Park (Grand Rapids), Ludington (also pickleball), DeWitt, Haslett, Williamsburg (Traverse City)." },
        ],
        links: [{ id: uid(), label: "Website", url: "https://24-7golf.com" }],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["chain", "franchise", "tier-1", "24/7", "unmanned"],
      },
      {
        id: uid(), pipeline: "golf_networks", company: "Golfzon Social", stage: "Cold Outreach", starred: false, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [
          { id: uid(), date: "2026-03-24", author: "drew", text: "Entertainment/social concept. 4 locations (NY area + Oak Brook, IL). Golfzon TwoVision sims. Full bar & food. Franchise planned. Smaller footprint currently. Less avid-golfer, more social demo. MEDIUM priority." },
        ],
        links: [{ id: uid(), label: "Website", url: "https://golfzonsocial.com" }],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["chain", "tier-3", "entertainment"],
      },
      {
        id: uid(), pipeline: "golf_networks", company: "The Swing Bays", stage: "Cold Outreach", starred: false, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [
          { id: uid(), date: "2026-03-24", author: "drew", text: "Golf club/fitness concept. Expanding (HQ: Parker, CO). Membership + fitness + coaching model. Trackman. Franchise via Fransmart. Dedicated golfers. Great local pilot opportunity." },
        ],
        links: [{ id: uid(), label: "Franchise Info", url: "https://fransmart.com/brand/the-swing-bays/" }],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["chain", "franchise", "tier-2", "fitness"],
      },
      /* ── Independents: 24/7 & Unmanned ── */
      {
        id: uid(), pipeline: "golf_networks", company: "Modern Eagle Golf", stage: "Cold Outreach", starred: false, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [{ id: uid(), date: "2026-03-24", author: "drew", text: "Single-bay private members club. Membership only. Trackman iO. 24/7 unmanned. No F&B. Ultra-premium feel aligns with high-end sub box. Template for approaching similar micro-clubs." }],
        links: [{ id: uid(), label: "Website", url: "https://www.moderneaglegolf.com" }],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["independent", "tier-1", "24/7", "unmanned", "membership"],
      },
      {
        id: uid(), pipeline: "golf_networks", company: "Twenty Fore Golf", stage: "Cold Outreach", starred: false, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [{ id: uid(), date: "2026-03-24", author: "drew", text: "Pinehurst, NC. 24/7 members-only access. Trackman. Pinehurst area = golfer paradise. HIGH priority." }],
        links: [{ id: uid(), label: "Website", url: "https://twentyfore.golf" }],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["independent", "tier-1", "24/7", "membership"],
      },
      {
        id: uid(), pipeline: "golf_networks", company: "Desert Links Indoor Golf", stage: "Cold Outreach", starred: true, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [{ id: uid(), date: "2026-03-24", author: "drew", text: "Phoenix, AZ (Arcadia neighborhood). 24/7 for members. $160+/mo memberships. Trackman. Upscale demo. Arcadia neighborhood = affluent. VERY HIGH priority." }],
        links: [{ id: uid(), label: "Website", url: "https://www.desertlinksgolf.com" }],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["independent", "tier-1", "24/7", "unmanned", "premium"],
      },
      {
        id: uid(), pipeline: "golf_networks", company: "Tee-Ed Off", stage: "Cold Outreach", starred: false, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [{ id: uid(), date: "2026-03-24", author: "drew", text: "Canandaigua, NY (Parkway Plaza). 6 bays, leagues, 24/7 access. Gold/Bronze membership tiers." }],
        links: [{ id: uid(), label: "Website", url: "https://tee-edoff.com" }],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["independent", "tier-1", "24/7"],
      },
      {
        id: uid(), pipeline: "golf_networks", company: "Precision Golf Lab", stage: "Cold Outreach", starred: false, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [{ id: uid(), date: "2026-03-24", author: "drew", text: "Denton, TX (Denton Square Business Center). Single bay, new (Dec 2025). 24/7 unmanned. Hourly (no membership). Trackman. MEDIUM priority." }],
        links: [],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["independent", "tier-1", "24/7", "unmanned"],
      },
      {
        id: uid(), pipeline: "golf_networks", company: "Another Nine", stage: "Cold Outreach", starred: false, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [{ id: uid(), date: "2026-03-24", author: "drew", text: "Cincinnati, OH (Columbia Tusculum). 24/7 unmanned private suites. Trackman. BYOB. Hourly (no membership req). Loyalty program. Donates 1% profits. Great grassroots affiliate partner." }],
        links: [{ id: uid(), label: "Website", url: "https://anothernine.com" }],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["independent", "tier-1", "24/7", "unmanned"],
      },
      /* ── Independents: Notable / Staffed ── */
      {
        id: uid(), pipeline: "golf_networks", company: "Atlanta Golf & Social", stage: "Cold Outreach", starred: false, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [{ id: uid(), date: "2026-03-24", author: "drew", text: "Atlanta, GA. Social club with multiple ATL locations. Locally owned. Premium/limited membership. Trackman. Full bar & food." }],
        links: [{ id: uid(), label: "Website", url: "https://www.atlantagolfandsocial.com" }],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["independent", "tier-2", "social", "premium"],
      },
      {
        id: uid(), pipeline: "golf_networks", company: "Ace Golf Club", stage: "Cold Outreach", starred: false, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [{ id: uid(), date: "2026-03-24", author: "drew", text: "Chicago, IL (West Loop / Fulton Market). Private, capped membership. 12 sims. AI simulators. No F&B. Affluent members." }],
        links: [{ id: uid(), label: "Website", url: "https://www.agolfclub.com" }],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["independent", "tier-2", "private", "premium"],
      },
      {
        id: uid(), pipeline: "golf_networks", company: "Nashville City Golf", stage: "Cold Outreach", starred: false, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [{ id: uid(), date: "2026-03-24", author: "drew", text: "Downtown Nashville, TN. Premium sim. Trackman iO. Upscale lounge. PGA instructor on staff. 500+ courses." }],
        links: [{ id: uid(), label: "Website", url: "https://www.nashvillecitygolf.com" }],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["independent", "tier-2", "premium"],
      },
      {
        id: uid(), pipeline: "golf_networks", company: "Evergreen Golf Club", stage: "Cold Outreach", starred: false, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [{ id: uid(), date: "2026-03-24", author: "drew", text: "WA area. Training-focused club. Simulators + PuttView. Short game complex. Family plans. Membership-based." }],
        links: [{ id: uid(), label: "Website", url: "https://evergreengolfclub.com" }],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["independent", "tier-2", "training"],
      },
      {
        id: uid(), pipeline: "golf_networks", company: "Back 9 Social", stage: "Cold Outreach", starred: false, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [{ id: uid(), date: "2026-03-24", author: "drew", text: "Connecticut (multiple locations). Upscale indoor golf + dining. Chef-driven menu + bar." }],
        links: [],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["independent", "tier-3", "social", "entertainment"],
      },
      /* ── Canadian Venues ── */
      {
        id: uid(), pipeline: "golf_networks", company: "Swing Golf Lounge", stage: "Cold Outreach", starred: false, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [{ id: uid(), date: "2026-03-24", author: "drew", text: "Toronto (Etobicoke), ON, Canada. Est. 2018. Staffed premium sim lounge. Trackman. Full bar & food. Leagues, events, corporate." }],
        links: [{ id: uid(), label: "Website", url: "https://swinggolflounge.ca" }],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["independent", "canada", "social"],
      },
      {
        id: uid(), pipeline: "golf_networks", company: "North Swing Golf Lounge", stage: "Cold Outreach", starred: false, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [{ id: uid(), date: "2026-03-24", author: "drew", text: "Barrie, ON, Canada. 6 sims, 20ft screens. HD Golf tech. Licensed lounge. Events/parties." }],
        links: [{ id: uid(), label: "Website", url: "https://www.northswing.ca" }],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["independent", "canada"],
      },
      {
        id: uid(), pipeline: "golf_networks", company: "Swing Space Golf", stage: "Cold Outreach", starred: false, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [{ id: uid(), date: "2026-03-24", author: "drew", text: "GTA, ON, Canada. Private, immersive sim experience. Advanced tech." }],
        links: [{ id: uid(), label: "Website", url: "https://www.swingspacegolf.ca" }],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["independent", "canada", "private"],
      },
      {
        id: uid(), pipeline: "golf_networks", company: "Swing Zone", stage: "Cold Outreach", starred: false, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [{ id: uid(), date: "2026-03-24", author: "drew", text: "ON, Canada. Multiple locations. Private rooms. Trackman 4 (Tour-preferred)." }],
        links: [{ id: uid(), label: "Website", url: "https://www.swingzone.ca" }],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["independent", "canada", "private"],
      },
      {
        id: uid(), pipeline: "golf_networks", company: "Apex Golf Suite", stage: "Cold Outreach", starred: false, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [{ id: uid(), date: "2026-03-24", author: "drew", text: "Richmond Hill, ON, Canada. Pre-launch. Premium sim. Founding member discounts available. Lounge." }],
        links: [{ id: uid(), label: "Website", url: "https://www.apexgolfsuite.com" }],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["independent", "canada", "pre-launch"],
      },
      {
        id: uid(), pipeline: "golf_networks", company: "PAR BAR (Topgolf Swing Suite)", stage: "Cold Outreach", starred: false, value: 0,
        contact: { name: "", title: "", email: "", phone: "" },
        dealOwner: "Drew", accountOwner: "Drew",
        notes: [{ id: uid(), date: "2026-03-24", author: "drew", text: "Toronto, ON, Canada. Inside Marriott Downtown. 2 bays. Topgolf Swing Suite tech. Full dining + cocktails. More casual/social." }],
        links: [{ id: uid(), label: "Website", url: "https://www.parbartoronto.com" }],
        createdDate: "2026-03-24", lastActivity: "2026-03-24", tags: ["independent", "canada", "social"],
      },
    ] as Deal[],
